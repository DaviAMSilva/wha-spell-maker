    ...
    divAbout?.appendChild(
        <div id="about-container">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item"><i class="me-2 fas fa-book" /><a href="https://theowlhouse.fandom.com/wiki/Glyph_Magic" target="_blank" rel="noopener noreferrer">The Owl House Wiki</a> for the images of the glyphs from the series.</li>
                <li class="list-group-item"><i class="me-2 fab fa-discord" /><a href="https://linktr.ee/whacord" target="_blank" rel="noopener noreferrer">WHACord</a>, where you can share your spell creations and discuss the series.</li>
                <li class="list-group-item"><i class="me-2 fab fa-reddit" /><a href="https://www.reddit.com/r/WitchHatAtelier/" target="_blank" rel="noopener noreferrer">Witch Hat Atelier Subreddit</a>, where you can share your spell creations and discuss the series.</li>
