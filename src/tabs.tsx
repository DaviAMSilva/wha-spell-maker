    ...
    divAbout?.appendChild(
        <div id="about-container">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item"><i class="me-2 fab fa-discord" /><a href="https://discord.gg/7jSruSGA" target="_blank" rel="noopener noreferrer">Witch Hat Atelier Discord Server</a> for being a place where you can share your spell creations.</li>
