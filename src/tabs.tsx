    ...
    divAbout?.appendChild(
        <div id="about-container">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item"><i class="me-2 fab fa-discord" /><a href="https://discord.gg/utKwRgw96Y" target="_blank" rel="noopener noreferrer">Witch Hat Atelier Discord Server</a> for being a place where you can share your spell creations and discuss the series.</li>
                <li class="list-group-item"><i class="me-2 fab fa-reddit" /><a href="https://www.reddit.com/r/WitchHatAtelier/" target="_blank" rel="noopener noreferrer">Witch Hat Atelier Subreddit</a> for being a place where you can share your spell creations and discuss the series.</li>
