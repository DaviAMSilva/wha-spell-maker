    ...
    divAbout?.appendChild(
        <div id="about-container">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item"><i class="me-2 fab fa-discord" /><a href="https://discord.com/invite/witchhatatelier" target="_blank" rel="noopener noreferrer">Witch Hat Atelier Discord Server</a> just because I want to bring attention to it.</li>
                <li class="list-group-item"><i class="me-2 fab fa-reddit" /><a href="https://www.reddit.com/r/WitchHatAtelier/" target="_blank" rel="noopener noreferrer">Witch Hat Atelier Subreddit</a> just because I want to bring attention to it.</li>
