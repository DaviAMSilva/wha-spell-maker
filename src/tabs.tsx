...
export default function updateCustomTabs() {
    ...
    document.getElementById("import-export-container")!.appendChild(
        <div class="container my-3">
            ...
            <button id="clear-spell" title="Will clear the editor to an empty spell, including custom images" type="button" class="btn btn-danger me-2" onclick={() => createJsonEditor(null)}><i class="fas fa-triangle-exclamation" /> Clear Spell</button>
            ...
            <div class="d-flex btn-group col-md-12 my-3" role="group">
                ...
                <button id="copy-link" type="button" class="btn btn-secondary flex-shrink-1"
